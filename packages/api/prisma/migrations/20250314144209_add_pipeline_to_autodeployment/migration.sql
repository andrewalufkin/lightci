...
CREATE TABLE "pipelines" (
    ...
    "deployment_mode" TEXT NOT NULL DEFAULT 'automatic',
...
CREATE TABLE "users" (
    ...
    "artifact_storage_used" INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE "notification_preferences" (
    ...
    "email_weekly_usage" BOOLEAN NOT NULL DEFAULT true,
...
CREATE TABLE "auto_deployments" (
    ...
    CONSTRAINT "auto_deployments_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "usage_records" ADD CONSTRAINT "usage_records_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "organizations"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "usage_records" ADD CONSTRAINT "usage_records_pipeline_run_id_fkey" FOREIGN KEY ("pipeline_run_id") REFERENCES "pipeline_runs"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "auto_deployments" ADD CONSTRAINT "auto_deployments_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "auto_deployments" ADD CONSTRAINT "auto_deployments_pipeline_id_fkey" FOREIGN KEY ("pipeline_id") REFERENCES "pipelines"("id") ON DELETE SET NULL ON UPDATE CASCADE;
